...
public class ConsolesActivity extends AppCompatActivity {
    ...
    private final static String TAG = ConsolesActivity.class.getSimpleName();
...
//                final String text = intent.getStringExtra(BtService.EXTRA_TEXT);
                ...
                Toast.makeText(ConsolesActivity.this, R.string.srv_disconnect, Toast.LENGTH_SHORT).show();
            }
        }
    };
