...
import bt.lcy.btread.use.ConsoleActivity;
...
//        intentFilter.addAction(BtService.ACTION_DATA_AVAILABLE);
    ...
    public void  tryToConsole(){
        if (btServicesAdapter == null)
        {
            Log.w(TAG,"btServicesAdapter null..... ");
            return ;
        }
        final BluetoothGattCharacteristic characteristic = btServicesAdapter.getChild(4,0);
        ...
        final Intent cmdIntent = new Intent(BtDeviceServicesActivity.this,ConsoleActivity.class);
        //cmdIntent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK | Intent.FLAG_ACTIVITY_NEW_TASK);
        startActivity(cmdIntent);
    }
}
